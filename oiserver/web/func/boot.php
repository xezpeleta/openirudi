...
#imgargs openirudi rw root=/dev/null vga=791  kmap=es sound=noconf useroi=root autologin server=<?= $clientParams['server']; ?> password=<?= $clientParams['password']; ?> type=<?= $clientParams['type']; ?> ip=<?= $clientParams['ip']; ?> netmask=<?= $clientParams['netmask']; ?> gateway=<?= $clientParams['gateway']; ?> dns1=<?= $clientParams['dns1']; ?> dns2=<?= $clientParams['dns2']?>
imgargs openirudi 
