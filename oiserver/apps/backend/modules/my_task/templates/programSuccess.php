...
<div id="sf_admin_container">
	<h1 style="float:left"><?php echo __('Program Task', array(), 'messages') ?></h1>
	<div id="sf_admin_content">
		<form action="<?php echo url_for('@my_task_program_save') ?>" method="post">	
		<!--
		...
		<?php //gaur disk_assoc pasa ?>
		<?php include_partial('select_imageset',array('pc_list'=>$pc_list,'imageset_assoc'=>$imageset_assoc,'disk_assoc'=>$disk_assoc,'is_when'=>true)) ?>
		</div>
