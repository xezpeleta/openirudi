...
<div id="sf_admin_container">
  <h1 style="float:left"><?php echo __('Permission list', array(), 'messages') ?></h1>
  ...
  <div id="sf_admin_content">
    ...
    <?php if($sf_user->hasCredential(array('sf_guard_permission_new','sf_guard_permission_edit'),false)):?>
