...
<td class="sf_admin_date sf_admin_list_td_created_at">
  <?php echo $sf_guard_user->getCreatedAt() ? format_date($sf_guard_user->getCreatedAt(), "f") : '&nbsp;' ?>
</td>
<td class="sf_admin_date sf_admin_list_td_last_login">
  <?php echo $sf_guard_user->getLastLogin() ? format_date($sf_guard_user->getLastLogin(), "f") : '&nbsp;' ?>
</td>
