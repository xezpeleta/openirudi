...
imgargs openirudi rw root=/dev/null vga=normal screen=800x600x24 kmap=es sound=noconf user=root user=root autologin server=<?= $clientParams['server']; ?> password=<?= $clientParams['password']; ?> type=<?= $clientParams['type']; ?> ip=<?= $clientParams['ip']; ?> netmask=<?= $clientParams['netmask']; ?> gateway=<?= $clientParams['gateway']; ?> dns1=<?= $clientParams['dns1']; ?> dns2=<?= $clientParams['dns2']." es\n"; ?>
