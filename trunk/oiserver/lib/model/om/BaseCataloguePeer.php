...
abstract class BaseCataloguePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('CatId', 'Name', 'SourceLang', 'TargetLang', 'DateCreated', 'DateModified', 'Author', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('catId', 'name', 'sourceLang', 'targetLang', 'dateCreated', 'dateModified', 'author', ),
		BasePeer::TYPE_COLNAME => array (self::CAT_ID, self::NAME, self::SOURCE_LANG, self::TARGET_LANG, self::DATE_CREATED, self::DATE_MODIFIED, self::AUTHOR, ),
		BasePeer::TYPE_FIELDNAME => array ('cat_id', 'name', 'source_lang', 'target_lang', 'date_created', 'date_modified', 'author', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('CatId' => 0, 'Name' => 1, 'SourceLang' => 2, 'TargetLang' => 3, 'DateCreated' => 4, 'DateModified' => 5, 'Author' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('catId' => 0, 'name' => 1, 'sourceLang' => 2, 'targetLang' => 3, 'dateCreated' => 4, 'dateModified' => 5, 'author' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::CAT_ID => 0, self::NAME => 1, self::SOURCE_LANG => 2, self::TARGET_LANG => 3, self::DATE_CREATED => 4, self::DATE_MODIFIED => 5, self::AUTHOR => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('cat_id' => 0, 'name' => 1, 'source_lang' => 2, 'target_lang' => 3, 'date_created' => 4, 'date_modified' => 5, 'author' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
